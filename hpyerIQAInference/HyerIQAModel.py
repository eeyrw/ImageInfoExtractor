...
class HyperNet(nn.Module):
    ...
    def __init__(self, lda_out_channels, hyper_in_channels, target_in_size, target_fc1_size, target_fc2_size, target_fc3_size, target_fc4_size, feature_size,
        ...
        self.res = resnet50_backbone(
            lda_out_channels, target_in_size, weights_dir)
...
def resnet50_backbone(lda_out_channels, in_chn, weights_dir, **kwargs):
    ...
    save_model = model_zoo.load_url(
        model_urls['resnet50'], model_dir=weights_dir)
