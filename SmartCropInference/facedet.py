...
class FaceDetector:
    def __init__(self, backend_target=0,
        ...
        # Instantiate YuNet
        self.model = YuNet(modelPath=modelPath,
                           inputSize=[320, 320],
...
if __name__ == '__main__':
    dtr = FaceDetector(modelPath='DLToolWeights/SmartCrop/face_detection_yunet_2023mar.onnx')
    dtr.detect(Image.open('xxxx.jpg'),outputVisualResult='a.jpg')